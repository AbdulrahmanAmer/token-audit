...
cp "$SRC/scripts/audit.mjs" "$SRC/scripts/quiet.mjs" "$SRC/scripts/quiet-tests.mjs" "$SRC/scripts/code-index.mjs" "$SRC/scripts/code-map.mjs" "$SRC/scripts/code-map-learn.mjs" "$DEST/scripts/"
